...
(function () {
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-divider"></div>
        <a class="nav-item" data-page="profilo.html" href="/admin/profilo.html">
            <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true"><circle cx="12" cy="8" r="4"/><path d="M4 20c0-4 3.6-7 8-7s8 3 8 7"/></svg>
