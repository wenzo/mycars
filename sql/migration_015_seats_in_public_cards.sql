-- migration_015_seats_in_public_cards.sql
-- Aggiunge la colonna seats alla view public_vehicle_cards
-- per supportare il filtro MinSeats della ricerca conversazionale AI.
