-- migration_009_cv_kw_in_public_cards.sql
-- Aggiunge horsepower_cv e power_kw alla view public_vehicle_cards
-- per esporre la potenza del motore (CV e kW) all'app mobile tramite l'API pubblica.
