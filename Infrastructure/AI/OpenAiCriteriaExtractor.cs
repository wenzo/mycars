...
public sealed class OpenAiCriteriaExtractor : ICriteriaExtractor
{
    ...
    public OpenAiCriteriaExtractor(IHttpClientFactory factory, IOptions<AiOptions> aiOpts)
    {
        _opts = aiOpts.Value.Providers.GetValueOrDefault("OpenAI") ?? new AiProviderOptions();
    ...
    public async Task<SearchCriteria?> ExtractAsync(string userQuery, CancellationToken ct)
    {
        ...
        // Risposta OpenAI: arguments è una stringa JSON da deserializzare
